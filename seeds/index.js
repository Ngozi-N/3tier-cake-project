...
const seedDB = async () => {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        const camp = new Campground({
            ...
            description: 'Find the best bakeries in Nigeria. Do you have a new bakery that qualifies to be on the list? Add its location, so all cake lovers can know about it today! Have a cake day...smiles',
            price,
            geometry: {
                type: "Point",
                coordinates: [
