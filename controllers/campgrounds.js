...
module.exports.createCampground = async (req, res, next) => {
    ...
    req.flash('success', 'Successfully added a new baking location!');
...
module.exports.showCampground = async (req, res,) => {
    ...
    if (!campground) {
        req.flash('error', 'Cannot find that baking location!');
...
module.exports.renderEditForm = async (req, res) => {
    ...
    if (!campground) {
        req.flash('error', 'Cannot find that bakery location!');
        return res.redirect('/campgrounds');
    }
...
module.exports.updateCampground = async (req, res) => {
    ...
    req.flash('success', 'Successfully updated bakery location!');
    res.redirect(`/campgrounds/${campground._id}`)
}
...
module.exports.deleteCampground = async (req, res) => {
    ...
    req.flash('success', 'Successfully deleted bakery location')
